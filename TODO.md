...
Lista de pendências levantadas em análise técnica da v2.7.4. Nada aqui é bloqueante — a lib funciona e passa nos 152 testes — mas são pontos a corrigir/endurecer nas próximas versões.
